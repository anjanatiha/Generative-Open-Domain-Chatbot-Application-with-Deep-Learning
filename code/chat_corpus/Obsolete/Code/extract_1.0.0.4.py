...
def all(parent_dir, extracted_dir, pre_processed_dir, movie_dir, output_file1, output_file2, vocab_file1, vocab_file2, dialouge_count, type_d):
	out_dir_path = parent_dir+ "/" + pre_processed + "/" + movie_dir
	filename = parent_dir+ "/" + extracted_dir + "/" + movie_dir + ".txt"
